// ─────────────────────────────────────────────────────────────────────────────
// EXECUTED RUNBOOK — the distribution is now under IaC (imported 2026-06-24; the live
// block lives in lib/aws-website-cdn-cdk-stack.mjs). Kept for the import procedure + rationale.
//
...
//   Accept, Accept-Encoding (no query string, no cookies; Origin/Referer dropped
//   2026-06-30), TTLs 0 / 86400 / 31536000. That cache key is load-bearing: Accept /
...
new cloudfront.CfnDistribution(this, 'aws-website-cdn-cdk-distribution', {
  distributionConfig: {
    ...
    defaultCacheBehavior: {
      ...
      // Cache key = Accept + Accept-Encoding only (variant-negotiation axes;
      // Origin/Referer dropped 2026-06-30 — they shredded the cache for zero use).
      forwardedValues: {
        queryString: false,
